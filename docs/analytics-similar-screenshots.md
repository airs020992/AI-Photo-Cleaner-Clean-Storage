...
3. `similar_screenshots_continue_tapped`
4. `similar_screenshots_system_delete_result`
...
- Trust: `continue_tapped / scan_completed` when `empty_result=false`.
- System friction: confirmed vs cancelled `system_delete_result`.
